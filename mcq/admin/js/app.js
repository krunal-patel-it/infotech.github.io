  ...
  showBulkUpload() {
    const body = `
      ...
      <p style="font-size:0.8rem;margin-bottom:12px;background:var(--bg);padding:10px;border-radius:8px;line-height:1.55;">
        ...
        Subject, Unit/Chapter, Session, Q. No., Question, Option A–D, Right Answer, Explanation, Difficulty, Previous Board Exam?, PYQ Status, PYQ / Source Year, Source Type, Verification Note<br><br>
    ...
    reader.onload = (e) => {
      try {
        ...
        const colMap = {
          ...
          chapterUnit: findCol('unit/chapter', 'unit / chapter', 'chapter / unit', 'chapter/unit', 'chapter', 'unit'),
          relevantSession: findCol('=session', 'relevant session', 'session', 'topic'),
